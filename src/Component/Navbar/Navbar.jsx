  ...
  return (
    <div className="navbar z-50 bg-base-100">
      <div className="navbar-start">
        ...
        </div> <img className=" w-20 h-20 hidden md:block lg:block" src={'https://i.ibb.co/ZL6v8qW/beach-island-landscape-logo-beach-logo-design-beach-logo-outdoor-summer-travel-sun-stock-free-vector.jpg'} alt="" />
